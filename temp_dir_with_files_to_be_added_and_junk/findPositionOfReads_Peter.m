function findPositionOfReads_Peter(sampleName,auxData)
...
runFileName = [userDir,'/CS/BAC/findAlignment_Peter/tmpRuns/alignTmp_',num2str(readLength),'_',sampleName,'/alignTmp_',sampleName];
basicAllocationFileName = [userDir,'/CS/BAC/findAlignment_Peter/dataForSim/alignTmp_',num2str(readLength),'_',sampleName,'/alignTmp_',sampleName];
currDir = [userDir,'/CS/BAC/findAlignment_Peter/tmpRuns/alignTmp_',num2str(readLength),'_',sampleName];
basicSaveName = [userDir,'/CS/BAC/findAlignment_Peter/alignTmp_',num2str(readLength),'_',sampleName];
...
if strcmp(parallelType,'cluster')
  ...
  for j=1:length(tmpInd)
    ...
    % run one part - with the name of the file
    runOneNodeBasedFindPositionOfReads_Peter(mFileName,saveFileName,tmpInd{j}(1),tmpInd{j}(end),auxData)
  end
