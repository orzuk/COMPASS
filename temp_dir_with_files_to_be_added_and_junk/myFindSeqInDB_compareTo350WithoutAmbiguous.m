...
function [idx]=myFindSeqInDB_compareTo350WithoutAmbiguous(seq,basicDir,i,k)
...
results = blastlocal('InputQuery',filename, 'Program', 'blastn','Database','~/CS/BAC/12Samples/454/idx/old_fasta_files_without_ambiguous/454idx.fa');
