function runSpecific(outFileDirName,numIter,readLength,pwr,nb,thresholdForCollectingBAC,groupSize,bdf)

if ~exist('bdf')
  bdf = 0;
end
disp(['bdf is: ',numstr(bdf)]);
...
brFlag = 1;
crGeneralFourth(prefix,outFileDirName,10,bdf,nb,pwr,numIter,[inf],0,0,readLength,'hour','week',150000,50000,400,brFlag,1,thresholdForCollectingBAC,groupSize);
crGeneralFourth(prefix,outFileDirName,10,bdf,nb,pwr,numIter,[inf],0,0,readLength,'hour','week',150000,50000,400,brFlag,0,thresholdForCollectingBAC,groupSize);
