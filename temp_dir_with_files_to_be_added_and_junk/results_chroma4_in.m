...
function [errorsMinorOverSequence,reordered_cData]=results_chroma4_in(basicDirName,fileName,cData,SangerSeq_start,AmplifiedSeq_start,lengthValidSanger,pos_xl,tmp_ind_W_454,tmp_ind_W_Solexa,sameNumbers,paperPosition,thresh,fs,th_sec2first)
%keyboar
lenName = 50;
