function [normalizedBac values,varargout]=prepareGroupOf1000DistributedSequenceFilesOr(readLength,tmpInd,basicSeqNameDir,basicSeqKey)
...
for i=1:numBAC
  normalizedBac(:,i) = normalizedBac(:,i)/len_uni(tmpInd(i));
end
%keyboard
