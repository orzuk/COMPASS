function runGeneralSpecificMixture(auxData)
...
l_noCorrection = [l400_noCorrection';l100_noCorrection';l200_noCorrection';l50_noCorrection';l36_noCorrection';l25_noCorrection';l10_noCorrection'];
l_withCorrection = [l400_withCorrection';l100_withCorrection';l200_withCorrection';l50_withCorrection';l36_withCorrection';l25_withCorrection';l10_withCorrection'];


%pos = [60*ones(length(l400),1);90*ones(length(l100),1);4*60*ones(length(l50),1)];
pos_noCorrection = [120*ones(length(l400_noCorrection),1);180*ones(length(l200_noCorrection),1);180*ones(length(l100_noCorrection),1);4*60*ones(length(l50_noCorrection),1);4*60*ones(length(l36_noCorrection),1);4*60*ones(length(l25_noCorrection),1);;4*60*ones(length(l10_noCorrection),1);];
