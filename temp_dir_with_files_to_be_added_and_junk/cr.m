function cr(basicPrefix,bdf,nb,np,numIter,nr)
      ...
      for readlen=[50]
        for ii=1:numIter
          ...
          for Nreads=nr
            ...
            [strinfilename{k}] = fun_prep_data_for_simulations_loadSpecificBAC2([],[],indsimbac_vec,Nbac_in_mixture,Nreads,readlen,npower,bac_dist_flag,seed,outfilename,N,createReadsFlag,1);
            saveSeed(k) = seed;
            ...
            if mod(k,10)==1
              ...
              fid = fopen([userDir,'/CS/BAC/dataForSim/set/sec/listOfR_',basicPrefix,'_',num2str(k)],'w');
...
unix(['chmod 0700 ',userDir,'/CS/BAC/dataForSim/set/sec/listOfR_',basicPrefix,'*']);
unix(['chmod 0700 ',userDir,'/CS/BAC/dataForSim/set/sec/run_*'])
save([userDir,'/CS/BAC/dataForSim/set/sec/',basicPrefix,'_list'],'totalListOfNames','totalListOfRuns')
