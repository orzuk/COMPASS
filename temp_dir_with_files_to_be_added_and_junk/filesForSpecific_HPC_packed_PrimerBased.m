...
clear
load ~/CS/BAC/database/bac16s_primers750
...
save('~/CS/BAC/s16_data_primers750_packed64','Sequence_packed64','len_uni')    
...
save ~/CS/BAC/listOfDoubles_primers750 d
...
load ~/CS/BAC/s16_data_primers750_packed64
load('~/CS/BAC/database/bac16s_primers750','Header_uni_amp_uni')
Sequence_packed64(d) = [];
len_uni(d) = [];
...
save ~/CS/BAC/primers750/datNoNonACGT/keyNoNonACGT_primers750 partition part positionInPart  len_uni
...
for i=1:length(part)-1
  ...
  list_seq =  ['save ~/CS/BAC/primers750/datNoNonACGT/packed64/seq_part_',num2str(i),' -struct Seq_tmp'];
  eval(list_seq)
  
  list_head = ['save ~/CS/BAC/primers750/datNoNonACGT/packed64/head_part_',num2str(i),' -struct Head_tmp'];
  eval(list_head)
...
Header_750 = Header_uni_amp_uni;
Sequence_750 = Sequence_uni_amp_uni;

save ~/CS/BAC/primers750/bac16s_primers750_full_without_ambiguous Header_750 Sequence_750
