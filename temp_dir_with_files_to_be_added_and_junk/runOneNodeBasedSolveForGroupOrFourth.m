function runOneNodeBasedSolveForGroupOrFourth(allocateToOne,basicAllocationFileName,mFileName,saveFileName,userDir,marilynNumber,queueName)
%keyboard
...
fprintf(fid,'%s/CS/BAC/cvx/run_solveForGroupOrFourth_Br.sh /broad/software/nonfree/Linux/redhat_5_x86_64/pkgs/matlab_2010b %s %s %s %s %s %s\n',...
        userDir, ...
