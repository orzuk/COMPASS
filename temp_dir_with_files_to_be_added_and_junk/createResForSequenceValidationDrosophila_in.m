function createResForSequenceValidationDrosophila_in(primerName)
...
for i=1:length(currSeq)
  ...
  for j=1:length(currHeader{i})
    ...
    res{i}{j}.s750 = struct;
    res{i}{j}.s450 = struct;
    [res{i}{j}.s750.Header,res{i}{j}.s750.Sequence,res{i}{j}.s750.Numbers,res{i}{j}.s450.Header,res{i}{j}.s450.Sequence,res{i}{j}.s450.Numbers,res{i}{j}.Full.Header,res{i}{j}.Full.Sequence,res{i}{j}.Full.Numbers]=findPositionOfAmpSequence(currSeq{i},currHeader{i}{j});
  end
end
...
save(['~/CS/BAC/12Samples/validation/scf_files_drosophila/res_',primerName],'res') 
