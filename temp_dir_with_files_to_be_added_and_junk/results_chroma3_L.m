function results_chroma3_L(fileName,res,SangerSeq_start,AmplifiedSeq_start,lengthValidSanger,pos_xl)
...
paperPosition = [0.6    0.001    0.39    0.9];
fs = 10;
thresh = 380;
disp('v3');
results_chroma3_in(basicDirName,fileName,res,SangerSeq_start,AmplifiedSeq_start,lengthValidSanger,pos_xl,tmp_ind_W_454,tmp_ind_W_Solexa,sameNumbers,paperPosition,thresh,fs);
