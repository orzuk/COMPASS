...
function [idx]=FindSeqInDB(seq,basicDir)



filename=[basicDir,'/tmp-' num2str(randi(1E8)) '.fa'];
fastawrite(filename,'head',seq);

results = blastlocal('InputQuery',filename, 'Program', 'blastn','Database','/homes/csfaculty/shental/CS/BAC/12Samples/454/idx/454idx.fa');
