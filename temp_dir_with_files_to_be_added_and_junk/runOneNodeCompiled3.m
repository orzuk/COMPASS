function runOneNodeCompiled3(allocateToOne,basicAllocationFileName,mFileName,saveFileName,userDir,marilynNumber,queueName)
%keyboard

disp('runOneNodeCompiled3. ')
...
if isempty(findstr(userDir,'/seq/'))
  ...
  fprintf(fid,'%s/CS/BAC/cvx/run_runOneNodeForCompilation2_Br.sh /broad/software/nonfree/Linux/redhat_5_x86_64/pkgs/matlab_2010b %s %s %s %s %s %s\n',userDir,num2str(allocateToOne(1)),' ',num2str(allocateToOne(end)) ,basicAllocationFileName,saveFileName,userDir);
