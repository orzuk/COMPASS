function runOneNodeBasedSolveForGroup3(allocateToOne,basicAllocationFileName,mFileName,saveFileName,userDir,marilynNumber,queueName)
%keyboard
...
if isempty(findstr(userDir,'/seq/'))
  ...
  fprintf(fid,'%s/CS/BAC/cvx/run_solveForGroup3_Br.sh /broad/software/nonfree/Linux/redhat_5_x86_64/pkgs/matlab_2010b %s %s %s %s %s %s\n',...
                    userDir, ...
