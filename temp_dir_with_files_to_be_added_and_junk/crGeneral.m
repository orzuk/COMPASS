function crGeneral(basicPrefix,outFileDirName,numProcessors,bdf,nb,np,numIter,nr,addNoiseFlagInput,correctMeasurementForReadErrorsFlagInput,readLength,slave_queueName,master_queueName,repeatWhenLowerThanThisValue,brFlag,mkdirFlag)
