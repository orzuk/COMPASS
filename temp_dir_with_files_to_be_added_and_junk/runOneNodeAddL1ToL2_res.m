function runOneNodeAddL1ToL2_res(basicAllocationFileName,mFileName,userDir,queueName)
%keyboard
...
fprintf(fid,'%s/CS/BAC/cvx/run_addL1toL2_res.sh /broad/software/nonfree/Linux/redhat_5_x86_64/pkgs/matlab_2010b %s %s %s %s %s \n',...
        userDir, ...
