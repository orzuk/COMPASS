function distributeBAC_generalOrFourth_orig(auxDataFileName)
...
%rmpath(genpath('/home/csfaculty/shental/Weizmann/ph2users/fenoam/'));rmpath('/home/csfaculty/shental/matlab');cd ~/CS/mFilesBAC;addpath('~/CS/mFilesBAC'); mcc -v -m distributeBAC_generalOrFourth  -d /homes/csfaculty/shental/CS/BAC/cvx -a grep.m  -a currReadsFourth.m -a findParametersReads.m -a fun_prep_data_for_simulations_loadSpecificBAC2OrFourth.m -a get_duplicates.m -a get_duplicates2.m -a getuserdir.m -a iterateParallelDistributedSequenceFilesOrFourth.m  -a myHistForBAC.m -a myUniqueUINT8.m -a randi.m -a newReadsBasedSeed2Or.m   -a prepareReadsForRandomSequences.m -a solveForGroupOrFourth.m   -a prepareGroupOf1000DistributedSequenceFilesOrFourth  -a runOneGroupOf1000ForCompilationFourth.m -a set_solution_bounds.m -a doRepeatsFourth.m -a calcPartFourth.m 

% create stand alone run files and then run them
%rmpath(genpath('/home/csfaculty/shental/Weizmann/ph2users/fenoam/'));rmpath('/home/csfaculty/shental/matlab');cd ~/CS/mFilesBAC;addpath('~/CS/mFilesBAC'); mcc -v -m distributeBAC_generalOrFourth  -d /home/csfaculty/shental/CS/BAC/cvx -a grep.m  -a currReadsFourth.m -a findParametersReads.m -a fun_prep_data_for_simulations_loadSpecificBAC2OrFourth.m -a get_duplicates.m -a get_duplicates2.m -a getuserdir.m -a iterateParallelDistributedSequenceFilesOrFourth.m  -a myHistForBAC.m -a myUniqueUINT8.m -a randi.m -a newReadsBasedSeed2Or.m   -a prepareReadsForRandomSequences.m -a solveForGroupOrFourth.m   -a prepareGroupOf1000DistributedSequenceFilesOrFourth  -a runOneGroupOf1000ForCompilationFourth.m -a set_solution_bounds.m -a doRepeatsFourth.m -a calcPartFourth.m


% compile at br
% cd /seq/orzuk2/compressed_sensing/metagenomics/next_gen/CS/mFilesBAC;addpath('/seq/orzuk2/compressed_sensing/metagenomics/next_gen/CS/mFilesBAC'); mcc -v -m distributeBAC_generalOrFourth  -d /seq/orzuk2/compressed_sensing/metagenomics/next_gen/CS/BAC/cvx/brComp -a grep.m  -a currReadsFourth.m -a findParametersReads.m -a fun_prep_data_for_simulations_loadSpecificBAC2OrFourth.m -a get_duplicates.m -a get_duplicates2.m -a getuserdir.m -a iterateParallelDistributedSequenceFilesOrFourth.m  -a myHistForBAC.m -a myUniqueUINT8.m -a randi.m -a newReadsBasedSeed2Or.m   -a prepareReadsForRandomSequences.m -a solveForGroupOrFourth.m   -a prepareGroupOf1000DistributedSequenceFilesOrFourth  -a runOneGroupOf1000ForCompilationFourth.m -a set_solution_bounds.m -a doRepeatsFourth.m -a calcPartFourth.m 
...
if auxData.realReadsFromFileFlag==0
  ...
  if auxData.inifiniteNumberOfReadsFlag==0
    ...
    if auxData.loadSavedReadsForLargeReadLengthAndManyReads==0
      disp('run regular. create reads. distributeBAC_generalOrFourth.m')
    ...
    if auxData.correctMeasurementForReadErrorsFlag
      disp('delete this distributeBAC_generalOrFourth.m')
      auxData.readsForCorrectReads = zeros(sum(uniqueReads_length),size(uniqueReads,2),'uint64');
      kk = 0;
      %keyboard
    ...
    end % if auxData.correctMeasurementForReadErrorsFlag
...
%distributeBAC_generalOrFourth('/seq/orzuk2/compressed_sensing/metagenomics/next_gen/CS/tmp/finiteReadsLong400Second/structFor_finiteReadsLong400Second_bac_dist_flag_0_Nbac_in_mixture_100_npower_0_readlen_400_numIter_1_Nreads_10000_Noise_1_Correction_0')

%distributeBAC_generalOrFourth('/seq/orzuk2/compressed_sensing/metagenomics/next_gen/CS/tmp/test/structFor_test_bac_dist_flag_0_Nbac_in_mixture_100_npower_0_readlen_100_numIter_1_Nreads_10000_Noise_1_Correction_0') 
