function jobList=runProblematic_findPositionOfReads_Peter(listOfProblematic,runFileName,tmpRunFileName,auxData)
...
for jj=1:length(listOfProblematic)
  submitProblematic_findPositionOfReads(runFileName,tmpName,tmpRunFileName,listOfProblematic(jj),auxData);
end
