function [normalizedBac values,varargout]=prepareGroupOf1000DistributedSequenceFilesOrFourth(readLength,tmpInd,basicSeqNameDir,basicSeqKey)

% the same as prepareGroupOf1000DistributedSequenceFilesOr, but does not normalize by the sequence length
