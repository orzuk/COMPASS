function [currX,currSumRelevantReads]=doRepeats2(uniqueReads,uniqueReads_length,curr_kp,parallelType,basicSaveName,k,userDir,runFileName,auxData)
...
for i=1:length(tmpRepeatRandomGroups)
  value_forRepeatRandomGroups(:,ind_col+1:ind_col+tmpRepeatRandomGroups(i)) = calcPart(curr_kp,uniqueReads,uniqueReads_length,parallelType,basicSaveName,k,userDir,runFileName,auxData,tmpRepeatRandomGroups(i));  
