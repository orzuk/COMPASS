function results_chroma4_A(fileName,cData,SangerSeq_start,AmplifiedSeq_start,lengthValidSanger,pos_xl,th_sec2first)
...
paperPosition = [0.5    0.001    0.49    0.95];
fs = 10;
thresh = 600;
disp('save errorsMinorOverSequence and reordered_cData')
[errorsMinorOverSequence,reordered_cData] = results_chroma4_in(basicDirName,fileName,cData,SangerSeq_start,AmplifiedSeq_start,lengthValidSanger,pos_xl,tmp_ind_W_454,tmp_ind_W_Solexa,sameNumbers,paperPosition,thresh,fs,th_sec2first);
