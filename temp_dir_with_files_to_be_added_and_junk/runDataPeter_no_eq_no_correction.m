function runDataPeter_no_eq_no_correction(basicDirName)

disp('datasetName is full16S without ambiguous')
readLength = 101;
currNumProcessors = 200;
readsDataFile = 'uniqueAlignedReadsPeter';
...
for i=1
  ...
  basicName = [dirName,'_noCorrection_',num2str(readLength)];
