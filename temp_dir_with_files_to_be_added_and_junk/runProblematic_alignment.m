function jobList=runProblematic_alignment(listOfProblematic,runFileName,tmpRunFileName,auxData)
...
for jj=1:length(listOfProblematic)
  submitProblematic_alignment(runFileName,tmpName,tmpRunFileName,listOfProblematic(jj),auxData);
end
