function [strinfilename,red]=fun_prep_data_for_simulations_loadSpecificBAC2Or(basicSeqKey,basicSeqNameDir,indsimbac_vec,Nbac_in_mixture,Nreads,readlen,npower,bac_dist_flag,seed_in,outfilename,N,createReadsFlag,saveToFileFlag,addNoiseFlag,ErrorStruct,ind_bac_in_mix_input)
