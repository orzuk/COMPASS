%%%%%%%%%%%% human samples
clear
load('~/CS/BAC/12Samples/Solexa/illumina_reads_Human_samples')
sampleName = {'O7','O10','S7','S10'};
prepareUniqueReads_Solexa(cellseq100_sample,100,sampleName,1:4);
prepareUniqueReads_Solexa(cellseq50_sample,50,sampleName,1:4);
...
clear
load('~/CS/BAC/12Samples/Solexa/illumina_reads_M_samples')
sampleName = {'M1','M2','M3','M4'};
prepareUniqueReads_Solexa(cellseq100_sample,100,sampleName,1:4);
prepareUniqueReads_Solexa(cellseq50_sample,50,sampleName,1:4);
...
prepareUniqueReads_Solexa(cellseq100_sample,100,sampleName,[1 2]);
prepareUniqueReads_Solexa(cellseq50_sample,50,sampleName,[1 2]);

prepareUniqueReads_Solexa(cellseq100_sample,100,sampleName,[4]);
prepareUniqueReads_Solexa(cellseq50_sample,50,sampleName,[4]);

% end SHAY samples


% add 
addReverseComplement_12SamplesSolexa({'O7','O10','S7','S10','M1','M2','M3','M4','S1','S2','S4'},100);
addReverseComplement_12SamplesSolexa({'O7','O10','S7','S10','M1','M2','M3','M4','S1','S2','S4'},50)
