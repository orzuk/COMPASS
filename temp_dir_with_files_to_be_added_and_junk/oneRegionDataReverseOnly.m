function [PrimerReadBySpeciesMat Primer_kmers_packed bactInRegion]=oneRegionDataReverseOnly(reg,readLength,SS)
...
p_position_inds = [p_position_inds_r*ones(1,length(bactInRegion))];
