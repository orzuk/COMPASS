function prepareWindow_12Samples_createReads_newVersion(auxData)
%keyboard
alignReads = load([auxData.uniqueReadsFilesName,'/',auxData.uniqueReadsFilesName],'uni_read_seq','freq_read'); 
