function findPositionOfReads_May12(sampleName,auxData)
...
load([userDir,'/CS/BAC/12Samples/Solexa/data/opt3_th50_mar25_2012/illumina_reads',num2str(readLength),'_',sampleName,'_unifreq_corr_opt3_th50'],'uni_read_seq')
...
runFileName = [userDir,'/CS/BAC/findAlignment_May12/tmpRuns/alignTmp_',num2str(readLength),'_',sampleName,'/alignTmp_',sampleName];
basicAllocationFileName = [userDir,'/CS/BAC/findAlignment_May12/dataForSim/alignTmp_',num2str(readLength),'_',sampleName,'/alignTmp_',sampleName];
currDir = [userDir,'/CS/BAC/findAlignment_May12/tmpRuns/alignTmp_',num2str(readLength),'_',sampleName];
basicSaveName = [userDir,'/CS/BAC/findAlignment_May12/alignTmp_May12_',num2str(readLength),'_',sampleName];
...
if strcmp(parallelType,'cluster')
  ...
  for j=1:length(tmpInd)
    ...
    % run one part - May12
    runOneNodeBasedFindPositionOfReads_May12(sampleName,readLength,mFileName,saveFileName,tmpInd{j}(1),tmpInd{j}(end))
  end
