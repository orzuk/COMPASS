function value_forRepeatRandomGroups=calcPart_divAndConc(curr_kp,uniqueReads,uniqueReads_length,parallelType,basicSaveName,k,userDir,runFileName,auxData,tmpRepeatRandomGroups)
...
%keyboard
[cX,cSumRelevantReads] = divAndCon(uniqueReads,uniqueReads_length,curr_kp_forRepeatRandomGroups,auxData.basicSeqNameDir,auxData.basicSeqKey,parallelType,[basicSaveName,'_k_',num2str(k+2000)],userDir,[runFileName,'_k_',num2str(k+2000)],auxData);
